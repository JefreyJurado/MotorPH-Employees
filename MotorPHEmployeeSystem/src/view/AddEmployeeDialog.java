...
public class AddEmployeeDialog extends JDialog {
    ...
    public AddEmployeeDialog(JFrame parent, EmployeeRepository repository) {
    ...
    private boolean validateEmployeeFields() {
        ...
        // VALIDATION 2: Employee Number Duplication Check

        Employee existingEmployee = employeeRepository.findByEmployeeNumber(empNumber);
        if (existingEmployee != null) {
            JOptionPane.showMessageDialog(this,
                "Employee Number " + empNumber + " already exists!\n" +
                "Existing employee: " + existingEmployee.getFullName(),
        ...
        // VALIDATION 3: SSS Format Validation
        ...
        // VALIDATION 4: PhilHealth Format Validation
        ...
        // VALIDATION 5: TIN Format Validation
        ...
        // VALIDATION 6: Pag-IBIG Format Validation
        ...
        // VALIDATION 7: Numeric Format Check
        ...
        // VALIDATION 8: Non-Negative Values Check
        ...
        // VALIDATION 10: Philippine Phone Format Check
        ...
        // VALIDATION 11: Low Salary Confirmation
